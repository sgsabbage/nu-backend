...
from nu.core.models import Character, Player, PlayerWindow
from nu.plugins.channels.models import Channel, ChannelCharacter
...
def init_db() -> None:
    ...
    to_add.extend([pub, admin, plotting])
    ...
    # secret = Room(name="Se London", status=RoomStatus.SECRET, area=london, x=0, y=4)
    ...
    # to_add.extend([london, centre, north, private_club])
